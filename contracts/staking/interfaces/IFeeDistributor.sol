...
interface IFeeDistributor {
    ...
    /// @param lockDataList The list of LockData
    event LockupRewardMultipliersSet(LockData[] lockDataList);
    ...
    /// @param lockDataList The list of LockData
    function setLockupRewardMultipliers(LockData[] calldata lockDataList) external;
