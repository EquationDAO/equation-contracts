...
interface IPositionRouter {
    ...
    event PositionExecutorUpdated(address account, bool active);
    ...
    event OpenLiquidityPositionCancelled(uint128 index, address payable executionFeeReceiver);
    ...
    event OpenLiquidityPositionExecuted(uint128 index, address payable executionFeeReceiver);
    ...
    /// @param executionFeeReceiver Receiver of the request execution fee
    event CloseLiquidityPositionCancelled(uint128 index, address payable executionFeeReceiver);

    /// @notice Emitted when close liquidity position request executed
    /// @param index Index of the executed request
    /// @param executionFeeReceiver Receiver of the request execution fee
    event CloseLiquidityPositionExecuted(uint128 index, address payable executionFeeReceiver);
    ...
    /// @param index Index of cancelled request
    /// @param executionFeeReceiver Receiver of the request execution fee
    event AdjustLiquidityPositionMarginCancelled(uint128 index, address payable executionFeeReceiver);

    /// @notice Emitted when adjust liquidity position margin request executed
    /// @param index Index of executed request
    /// @param executionFeeReceiver Receiver of the request execution fee
    event AdjustLiquidityPositionMarginExecuted(uint128 index, address payable executionFeeReceiver);
    ...
    /// @param index Index of the cancelled request
    /// @param executionFeeReceiver Receiver of the request execution fee
    event IncreaseRiskBufferFundPositionCancelled(uint128 index, address payable executionFeeReceiver);

    /// @notice Emitted when increase risk buffer fund position request executed
    /// @param index Index of the executed request
    /// @param executionFeeReceiver Receiver of the request execution fee
    event IncreaseRiskBufferFundPositionExecuted(uint128 index, address payable executionFeeReceiver);
    ...
    /// @param index Index of the cancelled request
    /// @param executionFeeReceiver Receiver of the request execution fee
    event DecreaseRiskBufferFundPositionCancelled(uint128 index, address payable executionFeeReceiver);

    /// @notice Emitted when decrease risk buffer fund position request executed
    /// @param index Index of the executed request
    /// @param executionFeeReceiver Receiver of the request execution fee
    event DecreaseRiskBufferFundPositionExecuted(uint128 index, address payable executionFeeReceiver);
    ...
    event IncreasePositionCancelled(uint128 index, address payable executionFeeReceiver);
    ...
    event IncreasePositionExecuted(uint128 index, address payable executionFeeReceiver);
    ...
    /// @param executionFeeReceiver Receiver of the request execution fee
    event DecreasePositionCancelled(uint128 index, address payable executionFeeReceiver);

    /// @notice Emitted when decrease position request executed
    /// @param index Index of the executed decrease position request
    /// @param executionFeeReceiver Receiver of the request execution fee
    event DecreasePositionExecuted(uint128 index, address payable executionFeeReceiver);
    ...
    /// @return cancelled Whether the cancellation succeeds
    ...
    /// @param executionFeeReceiver Receiver of the request execution fee
    function executeOpenLiquidityPosition(uint128 index, address payable executionFeeReceiver) external returns (bool);
    ...
    /// @param executionFeeReceiver Receiver of the request execution fee
    /// @return executed Whether the execution succeeds
    ...
    /// @param index Index of the request to execute
    /// @param executionFeeReceiver Receiver of the request execution fee
    /// @param executed Whether the execution succeeds
